            ...
            <div class="row">
                <div class="col-xl-9 mx-auto">
                    <div class="cta-inner text-center rounded">
                        ...
                        <p class="text-center mb-0">Telah terjadi error #AE.PTL, silakan hubungi Administrator</p>
                        <p class="text-center mb-0">Data yang dikirimkan terlalu besar untuk ditangani.</p>
                    </div>
                </div>
            </div>
        </div>
