                        ...
                        <div class="col-10">
                            <div id="application" class="card mb-4">
                                ...
                                <div id="action" class="card-footer d-none">
                                    ...
                                    <div class="form-row">
                                        <div class="col text-left"><label style="margin-left: 10px;font-size: 11px;font-family: Raleway, sans-serif;">CATATAN PROSES <span id="catatan" style="font-weight: bold;text-transform: uppercase;"></span>:</label><input class="form-control" type="text" style="font-family: Raleway, sans-serif;font-size: 14px;" name="catatan"></div>
                                    </div>
                                    <div class="form-row" style="margin-top: 15px;">
                                        <div class="col text-right"><a id="next" href="javascript:processApp('n')" class="btn btn-primary"></a> &nbsp; <a id="reroute" href="javascript:processApp('r')" class="btn btn-secondary"></a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
